...
//		System.exit(0);
		...
		MessageRecord[] re = Controller.getInstance().search("13", "Folder:Inbox", 0, 20);
		System.out.println("-------------------------------------------------");
		Controller.getInstance().search("12", "Folder:Sent", 0, 20);
		System.out.println("-------------------------------------------------");
		Controller.getInstance().search("12", "Folder:Inbox", 0, 20);
